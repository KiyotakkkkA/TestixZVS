...
export const TeacherCabinetPage = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto w-full space-y-4 animate-fade-in">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
                ...
                <div className="relative rounded-lg border border-slate-200 bg-slate-50 p-6 shadow-sm">
                    ...
                    />
                    <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-400 mt-4">
