        ...
        <div className="w-full">
            <div className="flex w-full flex-col gap-6 lg:flex-row">
                <aside className="w-full lg:w-72">
                        ...
                        <div className="mt-4 flex flex-col gap-3">
                            ...
                            <div>
                                ...
                                {searchQuery.trim().length > 0 && (
                                    <div className="mt-2 rounded-lg border border-slate-200 bg-slate-50 p-2 text-sm text-slate-600">
                    ...
                    <div className="mt-5 p-5 bg-slate-50 rounded-2xl space-y-3 border border-slate-200 shadow-sm">
                        <Button
                            primary
                            className="w-full px-4 py-2 text-sm"
                            onClick={() => {
